> [!hint] Si tiene que copiar varias líneas de un bloque de código en una aplicación o en un aviso de Cloud Shell, use el Bloc de notas como paso intermedio. Para ello, haga lo siguiente:
>
